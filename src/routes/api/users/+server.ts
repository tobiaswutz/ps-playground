...
export const POST = async ({ request }: any) => {
  ...
  try {
    ...
    const results = await conn.execute(`
      INSERT INTO user (email, name, last_name, phone_number, location, age, alias_name, account_created, last_login, online, avatar_url)
      VALUES (:email, :name, :last_name, :phone_number, :location, :age, :alias_name, :account_created, :last_login, :online, :avatar_url)
    `, body);
